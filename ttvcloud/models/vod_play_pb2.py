...
_VODGETORIGINALPLAYINFORESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='ResponseMetadata', full_name='Vcloud.Models.Vod.VodGetOriginalPlayInfoResponse.ResponseMetadata',
            index=0,
            number=1, type=11, cpp_type=10, label=1,
            has_default_value=False, default_value=None,
            message_type=None, enum_type=None, containing_type=None,
...
VodGetOriginalPlayInfoRequest = _reflection.GeneratedProtocolMessageType('VodGetOriginalPlayInfoRequest',
                                                                         (_message.Message,), {
...
VodGetOriginalPlayInfoResponse = _reflection.GeneratedProtocolMessageType('VodGetOriginalPlayInfoResponse',
                                                                          (_message.Message,), {
...
VodGetOriginalPlayInfoResult = _reflection.GeneratedProtocolMessageType('VodGetOriginalPlayInfoResult',
                                                                        (_message.Message,), {
